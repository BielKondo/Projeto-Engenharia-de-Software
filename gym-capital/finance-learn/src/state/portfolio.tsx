/**
 * ESTADO DA CARTEIRA DO USUÁRIO
 * ============================================================
 * Esse é o context MAIS importante do app. Cuida de:
 *
 *   1) Saldo (caixa disponível) e posições (ativos comprados)
 *   2) Histórico de transações (compras e vendas)
 *   3) Cotações dos ativos (atualizadas a cada 10 minutos)
 *   4) Alertas de preço (notifica quando ativo atinge um valor)
 *   5) Metas financeiras
 *
 * Tudo é persistido no localStorage com a chave gym-capital:portfolio:v3.
 *
 * Use em qualquer componente:
 *   const { estado, comprar, vender, criarAlerta } = usePortfolio();
 */
"use client";
...
export function PortfolioProvider({ children }: { children: ReactNode }) {
  ...
  // ============================================================
  // COTAÇÕES — atualiza preços a cada 10 minutos
  // ============================================================
  ...
  // ============================================================
  // CONSULTAS — funções para ler dados (não modificam estado)
  // ============================================================
  ...
  // ============================================================
  // AÇÕES — operações que MUDAM o estado da carteira
  // ============================================================
