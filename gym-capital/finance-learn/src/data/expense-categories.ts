/**
 * CATEGORIAS DE GASTOS E SUGESTÕES DE METAS — MOCK
 * ============================================================
 * Define as 10 categorias usadas no Controle de Gastos (/gastos)
 * — cada uma com cor (usada nos gráficos) e ícone (emoji).
 *
 * Também define 6 sugestões prontas de metas financeiras,
 * usadas no modal de "Nova Meta" (/relatorios).
 */
