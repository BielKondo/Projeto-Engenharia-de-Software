/**
 * BIBLIOTECA EDUCACIONAL — MOCK
 * ============================================================
 * Conteúdos exibidos na rota /biblioteca:
 *   - 15 itens divididos entre vídeos, artigos e cursos
 *   - 9 temas (Iniciação, Renda Fixa, Ações, FIIs, etc.)
 *   - 3 níveis (iniciante, intermediário, avançado)
 *
 * Itens marcados com `destaque: true` aparecem em cards maiores no topo.
 */
